package com.weshopify.platform.features.categories.service;
...
public class CategoryService 
{
	...
	public CategoryBean updateCategory(CategoryBean catBean) 
	{
		...
		/**
		 * prepare the command and transport it to the 
		 * command handler by the command Gateway
		 */
	    ...
	    // Checking whether command has been delivered or not
		 ...
		 {
			 throw new RuntimeException("command delivery cancelled");
		 }
		 else if (future.isCompletedExceptionally()) 
		 {
			 throw new RuntimeException("command Completed Exceptionally");
		 }
		 else
		 {
